# Graph Report - supplement-dawn  (2026-05-07)

## Corpus Check
- 38 files · ~31,185 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 606 nodes · 829 edges · 49 communities detected
- Extraction: 86% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 111 edges (avg confidence: 0.82)
...
- **Why does `fetchConfig()` connect `Community 10` to `Community 0`, `Community 4`, `Community 5`, `Community 12`, `Community 22`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `subscribe()` connect `Community 2` to `Community 0`, `Community 27`, `Community 4`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
