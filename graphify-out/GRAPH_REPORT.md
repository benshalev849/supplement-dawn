# Graph Report - supplement-dawn  (2026-07-20)

## Corpus Check
- 51 files · ~1,172,815 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 903 nodes · 1703 edges · 70 communities detected
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 122 edges (avg confidence: 0.81)
...
1. `BloomliSignupPopup` - 54 edges
2. `PredictiveSearch` - 24 edges
3. `p()` - 21 edges
4. `FacetFiltersForm` - 21 edges
5. `CartItems` - 17 edges
6. `SlideshowComponent` - 17 edges
7. `Dawn Theme` - 14 edges
8. `CartDrawer` - 12 edges
9. `MenuDrawer` - 12 edges
10. `removeTrapFocus()` - 11 edges

## Surprising Connections (you probably didn't know these)
- `updateFrequency()` --calls--> `fetchConfig()`  [INFERRED]
  bloomli-cart-drawer.js → global.js
- `updateFrequency()` --calls--> `publish()`  [INFERRED]
  bloomli-cart-drawer.js → pubsub.js
- `updateLineQuantity()` --calls--> `fetchConfig()`  [INFERRED]
  bloomli-cart-drawer.js → global.js
- `updateLineQuantity()` --calls--> `publish()`  [INFERRED]
  bloomli-cart-drawer.js → pubsub.js
- `addToCart()` --calls--> `fetchConfig()`  [INFERRED]
  bloomli-cart-routine-upsell.js → global.js
...
Cohesion: 0.06
Nodes (38): beginFrameSubmission(), bindSignupForm(), BloomliSignupPopup, clearActiveSubmission(), clearNewsletterMessages(), extractErrorMessage(), findSectionScopedElement(), finishFrameSubmission() (+30 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (23): DetailsModal, AccountIcon, BulkModal, CartPerformance, debounce(), DeferredMedia, fetchConfig(), focusVisiblePolyfill() (+15 more)

### Community 2 - "Community 2"
Cohesion: 0.1
Nodes (36): addToCart(), getRequestedSections(), getSectionInnerHTML(), replaceCartSections(), setLoading(), showError(), addPreProcessCallback(), buildRequestUrlWithParams() (+28 more)

### Community 3 - "Community 3"
Cohesion: 0.09
Nodes (7): initializeScrollAnimationTrigger(), initializeScrollZoomAnimationTrigger(), onIntersection(), percentageSeen(), FacetFiltersForm, FacetRemove, PriceRange

### Community 4 - "Community 4"
Cohesion: 0.15
Nodes (29): cartVariantsForProduct(), cleanErrorMessageOnType(), connectedCallback(), constructor(), currentPage(), disconnectedCallback(), getSectionsToRender(), getTotalBar() (+21 more)

### Community 5 - "Community 5"
Cohesion: 0.17
Nodes (27): build_parser(), cmd_generate(), cmd_seed_memory(), cmd_validate(), ensure_dirs(), entry_from_csv_row(), first_present(), generate_batch() (+19 more)

### Community 6 - "Community 6"
Cohesion: 0.29
Nodes (24): t(), a(), b(), c(), d(), e(), f(), g() (+16 more)

### Community 9 - "Community 9"
Cohesion: 0.26
Nodes (16): clamp(), getActiveIndex(), getActiveSnapIndex(), getAdjacentSnapIndex(), getCards(), getCardScrollLeft(), getMaxScroll(), getSnapPoints() (+8 more)

### Community 10 - "Community 10"
Cohesion: 0.16
Nodes (3): CartItems, CartRemoveButton, constructor()
...
Cohesion: 0.3
Nodes (14): cleanErrorMessageOnType(), connectedCallback(), constructor(), disconnectedCallback(), getSectionsToRender(), getSectionsUrl(), input(), listenForActiveInput() (+6 more)

### Community 15 - "Community 15"
Cohesion: 0.3
Nodes (13): closeSelector(), constructor(), filterCountries(), hidePanel(), normalizeString(), onContainerKeyDown(), onContainerKeyUp(), onItemClick() (+5 more)

### Community 16 - "Community 16"
Cohesion: 0.36
Nodes (13): clearErrorMessage(), clearInputFields(), connectedCallback(), constructor(), createErrorListItem(), disableableFields(), disableInputFields(), disconnectedCallback() (+5 more)

### Community 17 - "Community 17"
Cohesion: 0.27
Nodes (14): boardName(), chooseChunkCount(), extractArchive(), folderName(), inspectEmails(), isolateEmail(), locateBrowser(), main() (+6 more)
...
Cohesion: 0.37
Nodes (11): closeAccordion(), getFloatingCtaTarget(), getHeaderStackHeight(), getScrollProgress(), initAccordions(), initFloatingCtas(), isTargetVisible(), measureElementHeight() (+3 more)

### Community 20 - "Community 20"
Cohesion: 0.39
Nodes (10): announceLiveRegion(), constructor(), onBulletClick(), onSlideChanged(), onSlideChangedBullets(), playActiveMedia(), preventStickyHeader(), removeListSemantic() (+2 more)

### Community 21 - "Community 21"
Cohesion: 0.32
Nodes (11): captureSequence(), findBrowser(), inspectDocument(), isolateEmail(), main(), parseArgs(), planSegments(), printHelp() (+3 more)

### Community 22 - "Community 22"
Cohesion: 0.49
Nodes (9): createCombinedLoadingOverlay(), getRequestedSections(), getSectionInnerHTML(), replaceCartDrawerSections(), replaceCartIcon(), replaceMainCartSections(), setLoading(), showCartError() (+1 more)

### Community 23 - "Community 23"
Cohesion: 0.47
Nodes (9): getCards(), getMaxScroll(), getStep(), getViewport(), initAll(), initCarousel(), prefersReducedMotion(), scrollCarousel() (+1 more)
...
Cohesion: 0.42
Nodes (9): constructor(), hide(), preprocessHTML(), preventDuplicatedIDs(), preventVariantURLSwitching(), removeDOMElements(), removeGalleryListSemantic(), show() (+1 more)

### Community 27 - "Community 27"
Cohesion: 0.53
Nodes (8): closeFrequencyMenus(), getSectionInnerHTML(), getSections(), replaceCartSections(), setFrequencyDisplay(), setMenuOpen(), updateFrequency(), updateLineQuantity()
...
Cohesion: 0.44
Nodes (7): clamp(), getStep(), initAll(), initSection(), update(), updateControls(), updateFromPointer()

### Community 32 - "Community 32"
Cohesion: 0.61
Nodes (7): clamp(), getDesktopProgress(), getMobileProgress(), requestUpdate(), setReachedSteps(), setReachedStepsFromLine(), update()

### Community 33 - "Community 33"
Cohesion: 0.42
Nodes (7): ensureDollarPrefix(), formatDiscount(), formatMoney(), formatTemplate(), init(), initRoot(), parseCents()

### Community 35 - "Community 35"
Cohesion: 0.47
Nodes (7): connectedCallback(), constructor(), disconnectedCallback(), getCartQuantity(), getVolumePricingArray(), onInputChange(), updatePricePerItem()
...
Cohesion: 0.52
Nodes (5): constructor(), handleErrorMessage(), onSubmitHandler(), toggleSubmitButton(), variantIdInput()

### Community 43 - "Community 43"
Cohesion: 0.48
Nodes (5): constructor(), loadContent(), loadShopifyXR(), setupModelViewerUI(), setupShopifyXR()

### Community 44 - "Community 44"
Cohesion: 0.62
Nodes (5): finishAfterTransition(), getInitialIndex(), initBeneathSurface(), setAccordionState(), setActive()

### Community 45 - "Community 45"
Cohesion: 0.6
Nodes (4): constructor(), hide(), show(), showActiveMedia()

### Community 46 - "Community 46"
Cohesion: 0.53
Nodes (4): constructor(), copyToClipboard(), toggleDetails(), updateUrl()
...
Cohesion: 0.8
Nodes (3): getHeaderStackHeight(), getSelectorTarget(), initInlineCtas()

### Community 49 - "Community 49"
Cohesion: 0.6
Nodes (3): closePopover(), constructor(), togglePopover()

### Community 50 - "Community 50"
Cohesion: 0.7
Nodes (4): count_exact_dups(), count_pairs(), normalize(), sim()
...
- **Why does `fetchConfig()` connect `Community 1` to `Community 2`, `Community 4`, `Community 10`, `Community 42`, `Community 13`, `Community 22`, `Community 27`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `removeTrapFocus()` connect `Community 1` to `Community 0`, `Community 24`, `Community 14`, `Community 25`?**
