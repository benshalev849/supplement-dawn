# Graph Report - supplement-dawn  (2026-05-10)

## Corpus Check
- 38 files · ~31,165 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 607 nodes · 830 edges · 50 communities detected
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 111 edges (avg confidence: 0.82)
...
Cohesion: 0.04
Nodes (18): DetailsModal, AccountIcon, BulkModal, CartPerformance, DeferredMedia, getFocusableElements(), HeaderDrawer, HTMLUpdateUtility (+10 more)
...
- **Why does `debounce()` connect `Community 4` to `Community 0`, `Community 16`, `Community 11`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `fetchConfig()` connect `Community 9` to `Community 0`, `Community 3`, `Community 4`, `Community 11`, `Community 21`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `subscribe()` connect `Community 1` to `Community 32`, `Community 3`, `Community 27`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
