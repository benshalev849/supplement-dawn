# Graph Report - supplement-dawn  (2026-07-09)

## Corpus Check
- 49 files · ~1,198,030 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 877 nodes · 1608 edges · 70 communities detected
...
3. `FacetFiltersForm` - 21 edges
4. `CartItems` - 17 edges
5. `SlideshowComponent` - 17 edges
6. `Dawn Theme` - 14 edges
7. `CartDrawer` - 12 edges
8. `MenuDrawer` - 12 edges
9. `removeTrapFocus()` - 11 edges
10. `BulkAdd` - 11 edges
...
Cohesion: 0.04
Nodes (28): DetailsModal, AccountIcon, BulkModal, CartPerformance, debounce(), DeferredMedia, fetchConfig(), focusVisiblePolyfill() (+20 more)

### Community 2 - "Community 2"
Cohesion: 0.13
Nodes (36): beginFrameSubmission(), bindSignupForm(), clearActiveSubmission(), clearNewsletterMessages(), extractErrorMessage(), findSectionScopedElement(), finishFrameSubmission(), getCaptchaTokenInput() (+28 more)
...
Cohesion: 0.12
Nodes (31): addPreProcessCallback(), buildRequestUrlWithParams(), connectedCallback(), constructor(), disconnectedCallback(), fetchQuantityRules(), getSelectedVariant(), handleOptionValueChange() (+23 more)
...
Cohesion: 0.32
Nodes (13): cleanErrorMessageOnType(), constructor(), disconnectedCallback(), getSectionsToRender(), getSectionsUrl(), input(), listenForActiveInput(), listenForKeydown() (+5 more)
...
Cohesion: 0.61
Nodes (6): addToCart(), getRequestedSections(), getSectionInnerHTML(), replaceCartSections(), setLoading(), showError()
...
- **Why does `fetchConfig()` connect `Community 0` to `Community 5`, `Community 39`, `Community 10`, `Community 14`, `Community 26`, `Community 27`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `removeTrapFocus()` connect `Community 0` to `Community 24`, `Community 1`, `Community 13`, `Community 23`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `BloomliSignupPopup` connect `Community 1` to `Community 2`?**
