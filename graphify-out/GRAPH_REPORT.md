# Graph Report - supplement-dawn  (2026-06-10)

## Corpus Check
- 45 files · ~38,902 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 808 nodes · 1450 edges · 63 communities detected
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 118 edges (avg confidence: 0.81)
...
- `addToCart()` --calls--> `publish()`  [INFERRED]
  bloomli-cart-routine-upsell.js → pubsub.js
...
Cohesion: 0.05
Nodes (37): beginFrameSubmission(), bindSignupForm(), BloomliSignupPopup, clearActiveSubmission(), clearNewsletterMessages(), extractErrorMessage(), findSectionScopedElement(), finishFrameSubmission() (+29 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (21): DetailsModal, AccountIcon, BulkModal, CartPerformance, DeferredMedia, focusVisiblePolyfill(), getFocusableElements(), HeaderDrawer (+13 more)
...
Cohesion: 0.12
Nodes (30): addPreProcessCallback(), buildRequestUrlWithParams(), connectedCallback(), constructor(), disconnectedCallback(), fetchQuantityRules(), getSelectedVariant(), handleOptionValueChange() (+22 more)
...
Cohesion: 0.25
Nodes (14): closeFrequencyMenus(), getSectionInnerHTML(), getSections(), replaceCartSections(), setFrequencyDisplay(), setMenuOpen(), updateFrequency(), updateLineQuantity() (+6 more)
...
- **Why does `fetchConfig()` connect `Community 10` to `Community 1`, `Community 33`, `Community 4`, `Community 5`, `Community 12`, `Community 19`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `removeTrapFocus()` connect `Community 1` to `Community 0`, `Community 21`, `Community 13`, `Community 22`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `debounce()` connect `Community 5` to `Community 1`, `Community 18`, `Community 12`?**
