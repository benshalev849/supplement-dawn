...
## Corpus Check
- 45 files · ~38,867 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 805 nodes · 1441 edges · 62 communities detected
...
- `onSubmitHandler()` --calls--> `fetchConfig()`  [INFERRED]
  product-form.js → global.js
...
Cohesion: 0.05
Nodes (34): beginFrameSubmission(), bindSignupForm(), BloomliSignupPopup, clearNewsletterMessages(), extractErrorMessage(), findSectionScopedElement(), finishFrameSubmission(), getCaptchaTokenInput() (+26 more)
...
Cohesion: 0.1
Nodes (18): CartItems, CartRemoveButton, constructor(), debounce(), cleanErrorMessageOnType(), connectedCallback(), constructor(), disconnectedCallback() (+10 more)
...
- **Why does `fetchConfig()` connect `Community 4` to `Community 1`, `Community 2`, `Community 5`, `Community 37`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `removeTrapFocus()` connect `Community 1` to `Community 0`, `Community 26`, `Community 19`, `Community 12`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `debounce()` connect `Community 2` to `Community 1`, `Community 17`, `Community 33`?**
